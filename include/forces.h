...
typedef struct gravity_info gravity_info_t;
typedef struct spring_info spring_info_t;
typedef struct drag_info drag_info_t; 
typedef struct destructive_collision_info destructive_collision_info_t; 
typedef struct collision_force_info collision_force_info_t; 
typedef struct physics_collision_info physics_collision_info_t;
typedef struct enemy_collision_info enemy_collision_info_t; 
 ...
 */
void create_newtonian_gravity(scene_t *scene, double c, body_t *body1, body_t *body2);
