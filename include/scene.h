...
// Wrapper to hold a force, acting bodies, and important constants
typedef struct force_wrapper force_wrapper_t;

// A list of force wrappers and a function to free a force wrapper
typedef list_t force_list_t;
