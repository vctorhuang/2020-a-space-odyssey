...
//     int character;  // 1 if character, 0 if enemy    
//     int highD; 
// } body_info_t;
...
/**
 * Gets the radius of a body, if available.
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's radius, as a double
 */
...
/**
 * Gets the force of a body, if available.
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's radius, as a double
 */
 ...
 * @param body a pointer to a body returned from body_init()
 * @param color the body's new color in (R, G, B) form.
 */
...
/**
 * Changes a body's radius.
 * @param body a pointer to a body returned from body_init()
 * @param radius the body's new radius.
 */
void body_set_radius(body_t *body, double radius);

/**
 * Changes a body's shape.
 * @param body a pointer to a body returned from body_init()
 * @param shape the body's new list of vertices.
 */
...
void body_set_rotation_speed(body_t *body, double c); 
